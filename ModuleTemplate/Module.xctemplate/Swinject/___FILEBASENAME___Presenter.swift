...
class ___VARIABLE_productName___Presenter: ___VARIABLE_productName___ModuleInput, ___VARIABLE_productName___ViewOutput, ___VARIABLE_productName___InteractorOutput {
    ...
    private let router: ___VARIABLE_productName___RouterInput
    
    init(view: ___VARIABLE_productName___ViewInput, interactor: ___VARIABLE_productName___InteractorInput, router: ___VARIABLE_productName___RouterInput) {
        self.view = view
